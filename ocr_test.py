...
class App:
    def __init__(self, window, window_title, height , width ):
        ...
        # video frame 
        # Create a canvas that can fit the above video source size
        self.canvas = tk.Canvas(self.frame2, width = 1000, height = 800)
...
######################################### CAMERA CODE TO CAPTURE STILL IMAGE ##############################################
        ...
        #     show_img=cv2.resize(image,(1024,768))
        ...
        #     image= cv2.cvtColor(image,cv2.COLOR_GRAY2BGR)
            image=cv2.imread('output_images/26-01-2022__02-42-29PM.jpg')
...
############################################################################################################################
            ...
            for i in disp:
                ...
                if number!='' and check==True:
                    ...
                    cv2.rectangle(image_disp,(i['xmin'],i['ymin']),(i['xmax'],i['ymax']),(0,0,255),8)
